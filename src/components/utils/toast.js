...
const ToastComponent = (props) => {
  ...
  const renderToastType = (type, impactOn = 'color') => {
    switch (type) {
      case 'success':
        return impactOn == 'color' ? colors.green : 'checkmark';
      case 'warning':
        return impactOn == 'color' ? '#FFBB01' : 'warning';
      case 'error':
        return impactOn == 'color' ? colors.lightRed : 'close';
      case 'notice':
      ...
      default:
        return impactOn == 'color' ? colors.green : 'information-circle';
    }
  };
  ...
  return (
    <Animated.View
      ...
      <TouchableOpacity
        ...
        <Ionicons name="close-circle" color="black" size={22} />
      </TouchableOpacity>
      <Animated.View
